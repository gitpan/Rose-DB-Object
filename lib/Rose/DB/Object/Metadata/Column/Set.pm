...
Parse VALUE and return a reference to an array containing the set values.  DB is a C<Rose::DB> object that is used as part of the parsing process.  Both arguments are required.
