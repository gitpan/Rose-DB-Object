...
C<Rose::DB::Object::Std> is a subclass of C<Rose::DB::Object> that imposes a few more constraints on the tables is fronts.  In addition to the constraints described in the C<Rose::DB::Object> documentation, tables fronted by C<Rose::DB::Object::Std> objects must also fulfill the following requirements:
...
To achieve much of this functionality, C<Rose::DB::Object::Std> uses C<Rose::DB::Object::Std::Metadata> objects.  The C<meta()> method will create these form you.  You should not need to do anything special if you use the idimoatic approach to defining metadata as shown in the L<synopsis|SYNOPSIS>.  

=head1 METHODS

Only the methods that are overridden are documented here.  See the C<Rose::DB::Object> documentation for the rest.

=over 4

=item B<meta>

Returns the C<Rose::DB::Object::Std::Metadata> object associated with this class.  This object describes the database table whose rows are fronted by this class: the name of the table, its columns, unique keys, foreign keys, etc.  See the C<Rose::DB::Object::Std::Metadata> documentation for more information.
